...
/*   Updated: 2019/07/14 14:42:48 by mbotes           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_ls.h"

size_t	*ft_getformat(t_files *ptr)
{
	size_t		*arr;
	char		*tmp;
...
int		ft_printlongformat(t_files *files, unsigned int flags, char *path)
{
	t_files		*ptr;
	size_t		*arr;

	ptr = files;
	arr = ft_getformat(ptr);
	ptr = files;
